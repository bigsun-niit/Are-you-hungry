...
import fooddelivery.Buymenu.BuymenuGongcha;
...
public class BuyGongcha extends JFrame {
 
    private JFrame jf=new JFrame();
    private BuymenuGongcha        lii2 ; 
   ...
   public BuyGongcha() {
    ...
    public void list_11() {
        ...
        btnNewButton.addActionListener(new ActionListener() {
            ...
            lii2.list_1(textField.getText(),textField_1.getText());
