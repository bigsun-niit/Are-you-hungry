...
import fooddelivery.Buymenu.Buymenubishengke;
...
public class Buybishengke extends JFrame {
 
    private JFrame jf=new JFrame();
    private Buymenubishengke        li ; 
