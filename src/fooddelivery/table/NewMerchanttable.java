 ...
 * @author wupeiyu
 */
public class NewMerchanttable extends javax.swing.JFrame {
    ...
    public NewMerchanttable() {
        initComponents();
         String sql="SELECT * FROM Menu limit 41,100";
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 170, 180, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewMerchanttable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new NewMerchanttable().setVisible(true);
            }
        });
    }
