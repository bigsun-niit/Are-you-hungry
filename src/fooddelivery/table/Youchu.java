...
import fooddelivery.Buy.BuyYouchu;
 ...
 * @author wupeiyu
 */
public class Youchu extends javax.swing.JFrame {
    ...
    public Youchu() {
        initComponents();
         String sql="SELECT * FROM Menu limit 30,4";
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 140, 180, -1));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 140, 180, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Youchu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
