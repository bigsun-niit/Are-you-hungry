 ...
 * @author wupeiyu
 */
public class Dashang extends javax.swing.JFrame {
    ...
    public Dashang() {
        initComponents();
         String sql="SELECT * FROM Menu limit 5,4";
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 130, 180, -1));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 130, 180, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dashang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
