 ...
 * @author wupeiyu
 */
public class Sanshi extends javax.swing.JFrame {
    ...
    public Sanshi() {
        initComponents();
         String sql="SELECT * FROM Menu limit 35,4";
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 140, 180, -1));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 140, 180, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sanshi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
