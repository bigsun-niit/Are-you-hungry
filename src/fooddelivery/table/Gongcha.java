 ...
 * @author wupeiyu
 */
public class Gongcha extends javax.swing.JFrame {
    ...
    public Gongcha() {
        initComponents();
         String sql="SELECT * FROM Menu limit 15,4";
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 880, 104));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 140, 180, -1));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 140, 180, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Gongcha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
