...
import fooddelivery.Buy.BuyDashang;
...
public class BuymenuDashang extends JFrame {

    String[] list1 = {"6", "大尚龙虾海鲜烧烤_大尚招牌虾", "62.8", "0"};
    String[] list2 = {"7", "大尚龙虾海鲜烧烤_辣炒花甲", "19.9", "0"};
    String[] list3 = {"8", "大尚龙虾海鲜烧烤_馋嘴牛蛙仔", "23.8", "0"};
    String[] list4 = {"9", "大尚龙虾海鲜烧烤_秘制蒜香虾尾", "98", "0"};
    int flag = 0;
    double sum = 0;
    BuyDashang lii;
