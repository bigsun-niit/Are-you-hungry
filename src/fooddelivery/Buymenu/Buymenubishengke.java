...
public class Buymenubishengke extends JFrame {

    String[] list1 = {"1", "必胜客_超级至尊披萨套餐", "49.9", "0"};
    String[] list2 = {"2", "必胜客_超级大方披萨套餐", "139", "0"};
    String[] list3 = {"3", "必胜客_下午茶解馋双人餐", "49.9", "0"};
    String[] list4 = {"4", "必胜客_人气满满超值小吃套餐", "69", "0"};
    int flag = 0;
    double sum = 0;
    Buybishengke li;
