...
public class BuymenuYouchu extends JFrame {

    String[] list1 = {"31", "有厨生鲜_五花肉300g", "7.9", "0"};
    String[] list2 = {"32", "有厨生鲜_青椒250g", "3.5", "0"};
    String[] list3 = {"33", "有厨生鲜_大土豆500g", "3.8", "0"};
    String[] list4 = {"34", "有厨生鲜_胡萝卜250g", "2.8", "0"};
    int flag = 0;
    double sum = 0;
    Buybishengke li;
