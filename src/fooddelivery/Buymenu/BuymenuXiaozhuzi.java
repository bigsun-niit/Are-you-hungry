...
public class BuymenuXiaozhuzi extends JFrame {

    String[] list1 = {"21", "小竹子零食窝_天润爆款酸奶", "6.5", "0"};
    String[] list2 = {"22", "小竹子零食窝_七饼师傅椰丝球", "7.5", "0"};
    String[] list3 = {"23", "小竹子零食窝_蜂蜜杨梅", "3", "0"};
    String[] list4 = {"24", "小竹子零食窝_鼎源麻辣味苏打饼干", "6.8", "0"};
    int flag = 0;
    double sum = 0;
    BuyCoco lii1;
