...
import fooddelivery.Buy.BuyGongcha;
...
public class BuymenuGongcha extends JFrame {

    String[] list1 = {"16", "御质贡茶_熊猫奶盖茶", "18", "0"};
    String[] list2 = {"17", "御质贡茶_金钻奶茶", "16", "0"};
    String[] list3 = {"18", "御质贡茶_港式鸡蛋仔", "12", "0"};
    String[] list4 = {"19", "御质贡茶_黑糖脏脏鲜奶", "15", "0"};
    int flag = 0;
    double sum = 0;
    BuyGongcha lii2;
