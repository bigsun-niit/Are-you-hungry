...
import fooddelivery.Buy.BuySanshi;
import fooddelivery.Buy.Buybishengke;
...
public class BuymenuSanshi extends JFrame {

    String[] list1 = {"36", "叁拾加水果专家_妃子笑荔枝250g", "13.9", "0"};
    String[] list2 = {"37", "叁拾加水果专家_大樱桃250g", "16.9", "0"};
    String[] list3 = {"38", "叁拾加水果专家_进口加力果500g", "11.9", "0"};
    String[] list4 = {"39", "叁拾加水果专家_麒麟瓜(切)400g", "9.9", "0"};
    int flag = 0;
    double sum = 0;
    BuySanshi li;
