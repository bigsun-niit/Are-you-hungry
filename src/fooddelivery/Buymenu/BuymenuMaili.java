...
public class BuymenuMaili extends JFrame {

    String[] list1 = {"26", "麦栗工坊_500g庆佳味糖炒麦栗", "24.51", "0"};
    String[] list2 = {"27", "麦栗工坊_266g麦栗工坊原味葵花籽", "10", "0"};
    String[] list3 = {"28", "麦栗工坊_100g麦栗工坊腰果", "17.2", "0"};
    String[] list4 = {"29", "麦栗工坊_200g麦栗工坊奇异果干", "11.2", "0"};
    int flag = 0;
    double sum = 0;
    BuyMaili li;
